...
files = {
    "MLP": "D1_mlp_metrics.txt",
    "Random Forest": "D1_rf_metrics.txt",
    "XGBoost": "D1_xgb_metrics.txt",
    "AdaBoost": "D1_ada_metrics.txt",
    "Logistic Regression": "D1_logreg_metrics.txt",
    "KNN": "D1_knn_metrics.txt"
}
...
# ── Save Files ───────────────────────────────────────────────────────────────
df_summary.drop(columns=["F1_raw"]).to_csv("D1_model_comparison.csv", index=False)
df_ces_sorted.to_csv("D1_ces_scores.csv", index=False)

with open("D1_final_summary.txt", "w", encoding="utf-8") as f:
    f.write("="*80 + "\n")
    f.write("               MODEL COMPARISON TABLE (DATASET 1)\n")
    f.write("="*80 + "\n")
...
plt.tight_layout()
plt.savefig('D1_ces_comparison_bar_chart.png', dpi=300)

print("\nAggregation process completed. Results saved to D1_final_summary.txt and D1_ces_comparison_bar_chart.png")
